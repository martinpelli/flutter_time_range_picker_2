        ...
        ElevatedButton(
          onPressed: () {
            showTimeRangePicker(
              ...
              timeTextStyle: TextStyle(color: Colors.orange[700], fontSize: 24, fontStyle: FontStyle.italic, fontWeight: FontWeight.bold),
              activeTimeTextStyle: const TextStyle(color: Colors.orange, fontSize: 26, fontStyle: FontStyle.italic, fontWeight: FontWeight.bold),
            );
          },
        ...
        ElevatedButton(
          onPressed: () async {
            TimeRange? result = await showTimeRangePicker(
                ...
                disabledTime: TimeRange(startTime: const TimeOfDay(hour: 22, minute: 0), endTime: const TimeOfDay(hour: 5, minute: 0)),
        ...
        ElevatedButton(
          onPressed: () async {
            TimeRange? result = await showTimeRangePicker(
              ...
              disabledTime: TimeRange(startTime: const TimeOfDay(hour: 6, minute: 0), endTime: const TimeOfDay(hour: 10, minute: 0)),
              clockRotation: 180.0,
            );
                        ...
                        child: Column(
                          children: [
                            TimeRangePicker(
                              ...
                              strokeWidth: 4,
                              ticks: 12,
                              activeTimeTextStyle: const TextStyle(fontWeight: FontWeight.normal, fontSize: 22, color: Colors.white),
                              timeTextStyle: const TextStyle(fontWeight: FontWeight.normal, fontSize: 22, color: Colors.white70),
                              onStartChange: (start) {
                                setState(() {
                                  startTime = start;
                                });
